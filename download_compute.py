...
def all():
    download(
        "BearCall",
        "https://www.barchart.com/options/call-spreads/bear-call?orderBy=maxProfitPercent&orderDir=desc",
    )
    download(
        "BullPut",
    ...
    download(
        "IronCon",
        "https://www.barchart.com/options/short-condors?orderBy=breakEvenProbability&orderDir=desc",
    )
